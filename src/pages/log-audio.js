                ...
                >
                    <List>
                        ...
                        <ListItem style={{ display: 'flex', flexDirection: 'column' }}>
                            ...
                            <Dialog open={sharePopupOpen} onClose={closeSharePopup}>
                                <DialogTitle>Post/Share To Sync Manage Direct (SMD)</DialogTitle>
                                <DialogContent>
                                    <TextField
                                        id="outlined-basic"
                                        label="Caption"
                                    ...
                                    />
                                    <Typography>Translate: {dialogData.translate}</Typography>
                                    <Typography>Transcript: {dialogData.transcript}</Typography>
                                </DialogContent>
                                <DialogActions>
                                    <Button onClick={handletosmd}>POST</Button>
                                </DialogActions>
                            </Dialog>
                        </ListItem>
                    </List>
